...
| #define **MEM_WRITE_WATCH** 0x00200000 | Hace que el sistema realice un seguimiento de las páginas escritas en en la región asignada. Si especifica este valor, también debe especificar MEM_RESERVE.
